...
# ---------------------------------------------------------
# NẠP 100% DỮ LIỆU THỰC TẾ 66 PHÂN ĐOẠN TỪ BÁO CÁO
# ---------------------------------------------------------
csv_data = """Segment_ID,Behavior,Time_s,S_km,EC_Wh,EC_Wh_km
x_1_Giaiphong_seg1,Lái gắt,60,0.32529,4.817,14.808
...
x_1_Giaiphong_seg5,Bình thường,60,0.37197,5.0962,13.701
x_1_Giaiphong_seg6,Bình thường,60,0.48503,5.2807,10.887
x_1_Giaiphong_seg7,Bình thường,60,0.48018,5.1991,10.827
x_1_Giaiphong_seg8,Lái gắt,60,0.35923,4.8218,13.423
x_1_Giaiphong_seg9,Bình thường,60,0.44635,5.0715,11.362
x_1_Giaiphong_seg10,Bình thường,60,0.36285,4.604,12.688
x_1_Giaiphong_seg11,Bình thường,60,0.39444,3.7759,9.573
x_2_PhoHue_HangBai_seg1,Lái gắt,60,0.32677,4.5872,14.038
x_2_PhoHue_HangBai_seg2,Tắc đường,60,0.19387,2.6684,13.764
x_2_PhoHue_HangBai_seg3,Tắc đường,60,0.31567,3.2268,10.222
x_2_PhoHue_HangBai_seg4,Tắc đường,60,0.16878,2.181,12.922
x_2_PhoHue_HangBai_seg5,Tắc đường,60,0.17373,1.6079,9.2553
x_3_TruongChinh_seg1,Bình thường,60,0.34913,5.036,14.424
...
x_4_HangDa_HangCot_seg1,Lái gắt,60,0.26835,2.7992,10.431
x_4_HangDa_HangCot_seg2,Tắc đường,60,0.29821,3.4768,11.659
x_4_HangDa_HangCot_seg3,Tắc đường,60,0.28534,2.7786,9.738
x_4_HangDa_HangCot_seg4,Tắc đường,60,0.21036,1.5758,7.4907
x_5_HangDa_HangGiay_seg1,Lái gắt,60,0.24868,2.6386,10.61
x_5_HangDa_HangGiay_seg2,Tắc đường,60,0.31645,4.3932,13.883
x_5_HangDa_HangGiay_seg3,Tắc đường,60,0.32491,3.2283,9.9362
x_6_KimMa_seg1,Lái gắt,60,0.23851,4.1555,17.423
x_6_KimMa_seg2,Lái gắt,60,0.31624,3.5169,11.121
x_6_KimMa_seg3,Tắc đường,60,0.2695,3.1607,11.728
x_6_KimMa_seg4,Lái gắt,60,0.28432,4.2645,14.999
x_6_KimMa_seg5,Bình thường,60,0.40899,3.8676,9.4565
x_7_NLB_TS_TTD_seg1,Bình thường,60,0.37852,5.4012,14.27
x_7_NLB_TS_TTD_seg2,Tắc đường,60,0.33968,5.9546,17.53
x_7_NLB_TS_TTD_seg3,Bình thường,60,0.37391,4.4009,11.77
x_7_NLB_TS_TTD_seg4,Tắc đường,60,0.24341,4.2599,17.501
x_7_NLB_TS_TTD_seg5,Tắc đường,60,0.35346,3.453,9.7692
x_7_NLB_TS_TTD_seg6,Tắc đường,60,0.14007,1.766,12.608
x_7_NLB_TS_TTD_seg7,Lái gắt,60,0.16356,1.8235,11.149
...
x_8_NguyenThaiHoc_seg1,Tắc đường,60,0.30905,3.3227,10.752
x_8_NguyenThaiHoc_seg2,Tắc đường,60,0.30887,3.6117,11.693
x_8_NguyenThaiHoc_seg3,Tắc đường,60,0.32945,4.0346,12.246
x_8_NguyenThaiHoc_seg4,Tắc đường,60,0.3343,2.7616,8.2607
x_8_NguyenThaiHoc_seg5,Tắc đường,60,0.20839,2.2163,10.636
...
x_9_PhamHung_seg4,Tắc đường,60,0.23691,3.977,16.787
x_9_PhamHung_seg5,Tắc đường,60,0.18701,4.0983,21.915
...
x_10_TranHungDao_seg4,Lái gắt,60,0.2116,3.3338,15.755
x_10_TranHungDao_seg5,Lái gắt,60,0.26815,4.6985,17.522
x_10_TranHungDao_seg6,Tắc đường,60,0.36294,4.0432,11.14
x_10_TranHungDao_seg7,Tắc đường,60,0.25528,2.6078,10.216
"""
...
df['DEI'] = 11.5 / df['EC_Wh_km'] # Chuẩn là 11.5
...
# =========================================================
    ...
    if menu == "1. Tổng quan":
        ...
        with r2c1:
            st.markdown("**Phân bổ 66 Segments Thực tế**")
        ...
        with r2c2:
            ...
            fig_bar = px.bar(bar_data, x='Behavior', y='EC_Wh_km', text=bar_data['EC_Wh_km'].round(1), color='Behavior', color_discrete_map=colors)
            fig_bar.update_layout(xaxis_title="", yaxis_title="Wh/km", height=280, margin=dict(t=0,b=0,l=0,r=0))
            st.plotly_chart(fig_bar, use_container_width=True)
            
        st.markdown("**Bảng Dữ liệu gốc Kế thừa (66 Segments)**")
        st.dataframe(df[['Segment_ID', 'Behavior', 'S_km', 'V_tb_kmh', 'EC_Wh_km', 'DEI']], use_container_width=True, height=200)
        ...
        with c1:
            ...
            st.plotly_chart(fig_3d, use_container_width=True)
        with c2:
            st.info("📌 **Báo cáo K-means:** Đây là kết quả phân cụm dựa trên dữ liệu thật của bạn.")
            st.dataframe(df.groupby('Behavior').size().reset_index(name='Số lượng đoạn'))

    elif menu == "3. Bản sao số":
        st.markdown("### Hướng dẫn: Vui lòng nhập ID đoạn đường vào ô tìm kiếm để xem quỹ đạo Vận tốc chi tiết của từng đoạn.")
        st.info("Ví dụ: Nhập x_1_Giaiphong_seg1")

    elif menu == "4. Kinh tế (TCO)":
        st.markdown("### Quy đổi Tiêu hao Năng lượng sang Bài toán Tài chính")
        tco_data = pd.DataFrame({'Hành vi': ['Bình thường', 'Bình thường', 'Tắc đường', 'Tắc đường', 'Lái gắt', 'Lái gắt'], 'Loại chi phí': ['Tiền sạc điện', 'Tiền ắc quy']*3, 'Chi phí (Triệu VNĐ)': [0.60, 1.67, 0.69, 2.08, 0.96, 3.33]})
        fig_tco = px.bar(tco_data, x='Hành vi', y='Chi phí (Triệu VNĐ)', color='Loại chi phí', barmode='group', color_discrete_map={'Tiền sạc điện':'#3498db', 'Tiền ắc quy':'#e74c3c'})
